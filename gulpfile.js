...
gulp.task('watch', function() {
  ...
  gulp.watch(files.srcHTML, gulp.series('html', 'asyncWIFI'))
  gulp.watch(paths.src + '/**/*.pug', gulp.series('pug', 'asyncWIFI'))
  gulp.watch(paths.src + '/**/*.ejs', gulp.series('ejs', 'asyncWIFI'))
